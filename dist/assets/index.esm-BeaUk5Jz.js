<<<<<<<< HEAD:dist/assets/index.esm-BGSKNw3R.js
import{h as p,E as ae,_ as se,j as ce,v as de,l as ue,m as fe,n as G,p as v,q as C,C as O,r as N,t as le}from"./kalpana_logo-DcHN1GV3.js";import"./index-B4NBX_R5.js";/**
========
import{h as p,E as ae,_ as se,j as ce,v as de,l as ue,m as fe,n as G,p as v,q as C,C as O,r as N,t as le}from"./kalpana_logo-B814CWkk.js";import"./index-BGMN3VjR.js";/**
>>>>>>>> 1df18deca795a172845c77fdf0f7054d59f0d705:dist/assets/index.esm-BeaUk5Jz.js
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e,t){return le(t,()=>{(async()=>!e.onRegisteredHandler||!await k(e.firebaseDependencies)||await A(e).catch(()=>{}))()})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ct(){try{await de()}catch{return!1}return typeof window<"u"&&ue()&&fe()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(e=ce()){return ct().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),se(p(e),"messaging").getImmediate()}async function gt(e,t){return e=p(e),oe(e,t)}function yt(e){return e=p(e),dt(e)}function Tt(e,t){return e=p(e),ut(e,t)}async function It(e,t){return e=p(e),A(e,t)}async function vt(e){return e=p(e),pt(e)}function kt(e,t){return e=p(e),ft(e,t)}function St(e,t){return e=p(e),lt(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */st();export{yt as deleteToken,bt as getMessaging,gt as getToken,ct as isSupported,Tt as onMessage,kt as onRegistered,St as onUnregistered,It as register,vt as unregister};
