...
function ServiceMosaicCard({
  ...
  return (
    <Link
      to={href}
      className={`group relative isolate flex min-h-[210px] overflow-hidden rounded-[20px] bg-white shadow-[0_8px_22px_rgba(15,40,80,0.08)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,40,80,0.13)] ${
        isTall ? "flex-col lg:min-h-0" : "flex-col sm:flex-row lg:min-h-0"
      } ${className}`}
    >
      <div
...
export default function ServiceSection() {
  return (
    <section className="bg-[#EFEFEF] py-16 md:py-16">
