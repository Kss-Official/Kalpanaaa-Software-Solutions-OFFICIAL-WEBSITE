...
export function Services() {
  const itemList = { "@context": "https://schema.org", "@type": "ItemList", name: "Kalpanaaa Software Solutions — Services", itemListElement: SERVICES.map((service, index) => ({ "@type": "ListItem", position: index + 1, name: service.title, url: `https://kalpanaaasoftwaresolutions.com/services/${service.slug}` })) };
  return <div className="site-page min-h-screen">
    <SEO title="Software Engineering Services — Kalpanaaa Software Solutions (kalpanaaasoftwaresolutions.com)" description="Engineering services by Kalpanaaa Software Solutions (kalpanaaasoftwaresolutions.com): full-stack web, mobile apps, cloud DevOps, enterprise QA, RAG systems, and multi-agent AI." canonical="https://kalpanaaasoftwaresolutions.com/services" jsonLd={itemList} />
