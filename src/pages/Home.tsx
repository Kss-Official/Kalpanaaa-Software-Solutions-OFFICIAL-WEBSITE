...
export function Home() {
  ...
  return <div className="site-page min-h-screen">
    <SEO title="Kalpanaaa Software Solutions — Bespoke Engineering Partner" description="Bespoke engineering for IT automation, RAG systems, multi-agent workflows, and production software across government, healthcare, finance, and education." canonical="https://kalpanaaasoftwaresolutions.in/" jsonLd={faqJsonLd} />
    ...
    <section className="relative overflow-hidden border-b border-line/70">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-16 md:py-24 grid lg:grid-cols-[minmax(0,1fr)_minmax(480px,1.1fr)] gap-10 items-center">
        ...
        <VisualScene className="hero-scene" variant="service-constellation" labels={["WEB-ENG", "DEVOPS", "QA-VERIFY", "MOBILE", "AGENTS", "AI-RAG"]} title="Six Kalpanaaaa service disciplines connected to one engineering hub" />
      </div>
    </section>
