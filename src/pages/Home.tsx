...
export function Home() {
  ...
  return <div className="site-page min-h-screen">
    <SEO title="Kalpanaaa Software Solutions — Bespoke Engineering Partner | kalpanaaasoftwaresolutions.in" description="Official website of Kalpanaaa Software Solutions (kalpanaaasoftwaresolutions.in). Production-grade software engineering for government, healthcare, finance, education. RAG, multi-agent automation, full-stack web, mobile, DevOps, QA." canonical="https://kalpanaaasoftwaresolutions.in/" jsonLd={faqJsonLd} />
