...
export function ServiceDetail() {
  ...
  return <div className="site-page min-h-screen"><SEO title={`${service.title} — Kalpana Software Solutions (kalpanaaasoftwaresolutions.com)`} description={service.description} canonical={`https://kalpanaaasoftwaresolutions.com/services/${service.slug}`} jsonLd={jsonLd} />
