...
export function ServiceDetail() {
  ...
  const jsonLd = { "@context": "https://schema.org", "@type": "Service", name: service.title, description: service.description, serviceType: service.title, provider: { "@type": "Organization", name: "Kalpanaaaa Software Solutions Pvt. Ltd." }, areaServed: "IN" };
  return <div className="site-page min-h-screen"><SEO title={`${service.title} | Kalpanaaaa Software Solutions`} description={service.description} canonical={`https://kalpanaaasoftwaresolutions.in/services/${service.slug}`} jsonLd={jsonLd} />
