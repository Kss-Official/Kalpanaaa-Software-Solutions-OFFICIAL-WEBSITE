...
export function Work() {
  const itemList = { "@context":"https://schema.org", "@type":"ItemList", name:"Kalpanaaa Software Solutions — Case Studies", itemListElement:CASE_STUDIES.map((project,index)=>({"@type":"ListItem",position:index+1,name:project.title,url:`https://kalpanaaasoftwaresolutions.com/work/${project.slug}`})) };
  return <div className="site-page min-h-screen">
    <SEO title="Our Work & Case Studies — Kalpanaaa Software Solutions (kalpanaaasoftwaresolutions.com)" description="Case studies and engineering work by Kalpanaaa Software Solutions (kalpanaaasoftwaresolutions.com). Founder-led engagements across government, healthcare, and education." canonical="https://kalpanaaasoftwaresolutions.com/work" jsonLd={itemList} />
