...
export function Work() {
  const itemList = { "@context":"https://schema.org", "@type":"ItemList", name:"Kalpanaaaa Software Solutions — Case Studies", itemListElement:CASE_STUDIES.map((project,index)=>({"@type":"ListItem",position:index+1,name:project.title,url:`https://kalpanaaasoftwaresolutions.in/work/${project.slug}`})) };
  return <div className="site-page min-h-screen">
    <SEO title="Our Work — Case Studies | Kalpanaaaa Software Solutions" description="Founder-led engagements with measurable outcomes across government, healthcare, and education." canonical="https://kalpanaaasoftwaresolutions.in/work" jsonLd={itemList} />
