...
export function CaseStudyDetail() {
 ...
 return <div className="site-page min-h-screen"><SEO title={`${project.client} — ${project.title} | Kalpanaaaa`} description={project.description} canonical={`https://kalpanaaasoftwaresolutions.in/work/${project.slug}`} jsonLd={jsonLd}/>
