...
export function Industries() {
  const itemList = { "@context": "https://schema.org", "@type": "ItemList", name: "Industries Kalpana Software Solutions serves", itemListElement: INDUSTRIES.map((industry,index)=>({ "@type":"ListItem", position:index+1, name:industry.title, url:`https://kalpanaaasoftwaresolutions.com/industries/${industry.slug}` })) };
  return <div className="site-page min-h-screen">
    <SEO title="Industries Served — Kalpana Software Solutions (kalpanaaasoftwaresolutions.com)" description="Kalpana Software Solutions (kalpanaaasoftwaresolutions.com) engineers for government, healthcare, finance, and education with compliance-aware bespoke delivery." canonical="https://kalpanaaasoftwaresolutions.com/industries" jsonLd={itemList} />
