...
export function Industries() {
  const itemList = { "@context": "https://schema.org", "@type": "ItemList", name: "Industries Kalpanaaaa serves", itemListElement: INDUSTRIES.map((industry,index)=>({ "@type":"ListItem", position:index+1, name:industry.title, url:`https://kalpanaaasoftwaresolutions.in/industries/${industry.slug}` })) };
  return <div className="site-page min-h-screen">
    <SEO title="Industries — Government · Healthcare · Finance · Education | Kalpanaaaa" description="Kalpanaaaa Software Solutions engineers for government, healthcare, finance, and education with compliance-aware bespoke delivery." canonical="https://kalpanaaasoftwaresolutions.in/industries" jsonLd={itemList} />
